...
class PingPaginationView(discord.ui.View):
    def __init__(
        self, rift: commands.Bot, latency, database_latency, uptime, shard_info
    ):
        super().__init__()
        self.rift = rift
    ...
    def update_buttons(self):
        ...
        self.page_button.emoji = (
            "<:settings:1421385210167033979>"
            if self.page == 0
            else "<:clock:1421385310666883135>"
        )


    @discord.ui.button(
        emoji="<:left:1421385001315995821>",
    ...
    @discord.ui.button(
        emoji="<:right:1421384967069503579>", style=discord.ButtonStyle.gray
    )
...
class ReminderPaginationView(discord.ui.View):
    def __init__(self, rift: commands.Bot, reminders: List[dict], per_page: int = 5):
        super().__init__()
        self.rift = rift
...
class GuildPaginator(discord.ui.View):
    ...
    @discord.ui.button(
        emoji="<:right:1421384967069503579>", style=discord.ButtonStyle.primary
    )
    async def next_page(
        self, interaction: discord.Interaction, button: discord.ui.Button
    ):
